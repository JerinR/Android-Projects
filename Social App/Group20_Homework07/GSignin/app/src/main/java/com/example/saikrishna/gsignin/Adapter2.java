...
/**
 * Created by saikrishna on 11/19/17.
 */
...
public class Adapter2 extends RecyclerView.Adapter<Adapter2.ViewHolder> {
    ...
    public Adapter2(ArrayList<Profile> mData, Context activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.section1,parent,false );
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            name = (TextView)itemView.findViewById(R.id.FriendNameTextView);
            img = (ImageView) itemView.findViewById(R.id.Section1FriendICon);
